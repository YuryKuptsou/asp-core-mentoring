...
namespace IO.Swagger.Model
{
    ...
    public partial class ProductDTO :  IEquatable<ProductDTO>, IValidatableObject
    {
        ...
        public ProductDTO(int? productID = default(int?), string productName = default(string), string quantityPerUnit = default(string), double? unitPrice = default(double?), int? unitsInStock = default(int?), int? unitsOnOrder = default(int?), int? reorderLevel = default(int?), bool? discontinued = default(bool?), int? supplierID = default(int?), string companyName = default(string), int? categoryID = default(int?), string categoryName = default(string))
        {
